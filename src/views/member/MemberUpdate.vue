    ...
    <div class="container">
      ...
      >
        <el-form-item label="员工姓名" prop="name">
          <el-input v-model="ruleForm.name" :disabled="true" maxlength="20"/>
        </el-form-item>
...
import validate from "@/assets/js/validate";
  export default {
    ...
    data() {
      return {
        id: this.$store.state.memberUpdateId,
        actionType : '',
        ruleForm : {
          'name': '',
          'phone': '',
    ...
    methods: {
      async init () {
        MemberApi.queryEmployeeById(this.id).then(res => {
          console.log(res)
      ...
      submitForm (formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            MemberApi.editEmployee(params).then(res => {
              if (res.data.code === 1) {
